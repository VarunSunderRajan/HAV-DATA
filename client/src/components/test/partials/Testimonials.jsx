...
import wc from '../images/westcanna.jpg';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4">Trusted by companies across Canada</h2>
            <p className="text-xl text-gray-600" data-aos="zoom-y-out">Hear from our clients below.</p>
          </div>

          {/* Items */}
          <div className="flex items-center justify-center py-2 col-span-2 md:col-auto col-start-2 col-end-4">

          <img className="flex" src={wc} width="96" height="96" alt="" />
            ...
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                <div className="absolute top-0 -mt-8 left-1/2 transform -translate-x-1/2">
                  ...
                  <img className="relative rounded-full" src={ali} width="96" height="96" alt="Testimonial 01" />
                </div>
                <blockquote className="text-xl font-medium mb-4">
                  “ After the HAV team's help with the opening of our second location, they have become our primary resource in identifying which products sell the best, at different locations. Thanks to the HAV team for all their help. “
                </blockquote>
                <cite className="block font-bold text-lg not-italic mb-1">Ali Wasuk</cite>
                <div className="text-gray-600">
                  <span>CEO & Co-Founder</span> <a className="text-blue-600 hover:underline" href="#0">@WestCanna</a>
                </div>
              </div>
